...
import { Bell, Mic, FileText, Store, TrendingUp, Cpu, CloudLightning, ShieldCheck } from 'lucide-react';
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        <div className={styles.userInfo}>
          ...
          <div>
            {/* Show exactly what user entered */}
            <h1 className={styles.greeting}>Namaste, {user?.name}! 🙏</h1>
        ...
        >
          <div className={styles.aiContent}>
            ...
            <p className={styles.aiSubtitle}>
              Ask Kisan Setu AI anything about farming, crops, or loans.
            </p>
          </div>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.cardsScroll}>
            ...
            <div className={styles.updateCard}>
              ...
              <h4 className={styles.cardTitle}>PM-KISAN ₹6k</h4>
              <p className={styles.cardDesc}>Kist status check karein.</p>
            </div>
          </div>
        </div>
      </div>
